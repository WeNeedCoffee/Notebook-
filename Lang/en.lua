local localization_strings = {
		...
		SI_NBUI_ACTIVELINKS_NAME  		= "Active Links",
		SI_NBUI_ACTIVELINKS_TOOLTIP  	= "Whether links are clickable, such as item links.",

		SI_NBUI_COPYMAIL_NAME  		= "Take Note",
		SI_NBUI_COPYMAIL_TOOLTIP  	= "Display a keybind to copy mail into a new page, or update an existing one.",

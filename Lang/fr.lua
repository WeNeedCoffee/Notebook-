local localization_strings = {
		...
		SI_NBUI_ACTIVELINKS_NAME 	= "Liens actifs",
		SI_NBUI_ACTIVELINKS_TOOLTIP = "Si des liens sont cliquables, tels que des liens d'élément.",

		SI_NBUI_COPYMAIL_NAME 		= "Prendre note",
		SI_NBUI_COPYMAIL_TOOLTIP 	= "Afficher un raccourci clavier pour copier le courrier dans une nouvelle page ou en mettre à jour un déjà existant.",

		SI_NBUI_MARKUP_NAME 		= "Basculer le balisage",

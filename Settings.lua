function CreateNBUISettings()
	...
	local panelData = {
		...
		resetFunc = function()
			...
			local _,a,_,b,x,y = NBUI.NB1MainWindow:GetAnchor()
	...
	-- Chat links are active.
	table.insert(optionsData, {
		type = "checkbox",
		name = GetString(SI_NBUI_ACTIVELINKS_NAME),
		tooltip = GetString(SI_NBUI_ACTIVELINKS_TOOLTIP),
		getFunc = function() return NBUI.db.NB1_ClickableLinks end,
		setFunc = function(v) NBUI.db.NB1_ClickableLinks = v end,
	})

	-- Copy mail to new page.
	table.insert(optionsData, {
		type = "checkbox",
		name = GetString(SI_NBUI_COPYMAIL_NAME),
		tooltip = GetString(SI_NBUI_COPYMAIL_TOOLTIP),
		getFunc = function() return NBUI.db.NB1_MailToPage end,
		setFunc = function(v) NBUI.db.NB1_MailToPage = v end,
	})

	-- -- Copy mail to new page.
	-- table.insert(optionsData, {
	-- 	type = "dropdown",
	-- 	name = 'Make Note From Mail',
	-- 	tooltip = 'Make a new page from matching mail, with a keybind or automatically.',
	-- 	-- choices = NBUI.BookTexturesNames,
	-- 	-- choicesValues = NBUI.BookTextures,
	-- 	choices = {'Disable', 'Keybind', 'Automatic'},
	-- 	choicesValues = {0, 1, 2},
	-- 	getFunc = function() return NBUI.db.NB1_MailToPage end,
	-- 	setFunc = function(v) NBUI.db.NB1_MailToPage = v end,
	-- 	default = NBUI.settings.NB1_MailToPage,
	-- })
